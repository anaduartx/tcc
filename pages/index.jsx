...
export default function Tudo(){
  return(
    ...
    <Topo></Topo>
    <Home titulo="URBAN ECONOMY" texto="Focamos na promoção de um modo de vida sustentável, baseado no consumo e produção responsável. Nossos produtos de roupas de criança, que acabam por ter uma curta vida útil em razão do rápido crescimento nessa faixa etária. Através da troca de roupas entre famílias, planejamos reduzir o número de roupas descartadas indevidamente e auxiliar no planejamento financeiro de famílias. "></Home>
